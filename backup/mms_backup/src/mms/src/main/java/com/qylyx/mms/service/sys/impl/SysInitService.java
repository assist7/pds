package com.qylyx.mms.service.sys.impl;
...
import com.qylyx.mms.dao.sys.ISysInitDao;
import com.qylyx.mms.exception.MmsException;
import com.qylyx.mms.framework.service.BaseService;
import com.qylyx.mms.service.sys.ISysInitService;
...
public class SysInitService extends BaseService<Object> implements ISysInitService {
	...
	public void initDbSql() {
		try {
			...
			throw new MmsException("初始化数据库脚本异常！", e);
		}
	}
